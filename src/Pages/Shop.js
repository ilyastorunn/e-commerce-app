...
const Shop = () => {
  ...
  return (
    <div className="container" id="shopBody">
      <div id="filterSection">
        <SearchBar onSearch={handleSearch} />
        <div className="filterButtons d-flex justify-content-center gap-2">
          <div className="btn-group" id="genderButtons">
            ...
            <Link to="/shop?category=all">
              <button
                className={`btn btn-outline-secondary allButton ${
      ...
      <div className="products">
        {filteredProducts.map((item) => (
          <div key={item.id}  id="productPics">
